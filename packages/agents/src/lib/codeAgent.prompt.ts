...
export const codeAgentPrompt: IAgentPrompt = {
  ...
  In the end you have to call the \`finalAnswer\` UDF with the final answer as the argument.
  ...
  planning: {
    ...
    initialPlan: ` 
    You are a world expert at making efficient plans to solve any task using a set of carefully crafted UDFs.
    ...
    You are a world expert at making efficient plans to solve any task using a set of carefully crafted UDF.
